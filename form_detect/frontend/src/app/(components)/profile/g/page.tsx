...
export default function Profile() {
  ...
  return (
    <div className="p-4 justify-items-center items-start grid grid-cols-1  md:grid-cols-3 lg:grid-cols-4 gap-10 h-full  bg-blue-400 ">



      <div className=" md:h-20 w-20 sm:h-40"><img className="hover:scale-110 transition" src="https://cdn.iconsax.io/icons/free/rounded/business/bold/personalcard_user-profile-contact-information-id-card-temp.webp" alt="" />
      ...
      <div className="md:h-20 w-20 sm:h-40"><img className="hover:scale-110 transition " src="https://cdn.iconsax.io/icons/free/rounded/location/bold/global-search_find-query-explore-search-results-information-temp.webp" alt="" />
      ...
      <div className="md:h-20 w-20 sm:h-40"><img className="hover:scale-110 transition" src="https://cdn.iconsax.io/icons/pro/rounded/travel/linear/search_magnifying-glass-find-query-locate-discover-information-temp.webp" alt="" />
      ...
      <div className="md:h-20 w-20 sm:h-40 "><img className="hover:scale-110 transition" src="https://cdn.iconsax.io/icons/pro/rounded/essential/linear/question-mark-circle_help-information-query-support-assistance-faq-temp.webp" alt="" />
