          ...
          <form onSubmit={handleSubmit(submitdata)} className='mr-5 font-serif' >
            ...
            <div>----------------------------------- or -------------------------------------</div>
                <div className='ml-25 my-5'>
                  <p  className='mt-5'>
                    Sign up with  
                    <Link href="/google" className='m-3.5 text-blue-400'> @google account </Link>
                  </p><p  className='mt-5'>
                    Sign up with  
                    <Link href="/github" className='m-3.5 text-blue-400'> @github account</Link>
                  </p><p className='mt-5'>
                    Sign up with  
                    <Link href="/microsoft" className='m-3.5 text-blue-400'> @microsoft account</Link>
                  </p><p className='mt-5'>
                    Sign up with  
                    <Link href="/apple" className='m-3.5 text-blue-400'> @apple account</Link>
                  </p>
                </div>
