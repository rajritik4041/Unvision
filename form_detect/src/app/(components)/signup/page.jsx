...
function page() {
  ...
  return (
    <div>
      <div className='flex justify-center items-center overflow-y-scroll h-full bg-linear-to-r from-blue-500 to-teal-400'>
        ...
        <div className='border-0 rounded-lg h-360  w-190 bg-radial from-blue-800 text-white via-blue-900 to-blue-950 flex felx-col justify-center gap-4 p-1 mt-2.5 m-4 bg-white font-mono font-bold'>
 <div className='mr-20 w-1'>
          ...
          <form onSubmit={handleSubmit(submitdata)} className='ml-10' >
            <div className= 'flex justify-center items-center border-0 rounded-lg bg-blue-500 p-1  my-5  font-mono'> PLEASE SIGN UP </div>
            <input type="text" name="text" placeholder='text' className='hidden border-2 m-2' />
            <div>

              <label htmlFor="firstname" className='p-1 my-4 font-mono '> First Name :</label>
...
<br />
            ...
            <div className=''>
              ...
              <label htmlFor="dateofbirth" className='p-1  my-3  font-mono'>D.O.B :</label>
              ...
              <label htmlFor="age" className='p-1 my-3  font-mono ml-1.5 ' >Age :</label>
...
<br />
              <label htmlFor="gender" className='p-1  my-3  font-mono  '>Gender :</label>
            ...
            <div className='p-1.5'>
              <label htmlFor="username" className='p-1  my-3  font-mono '>UserName :</label>
            ...
            <div>
              <label htmlFor="cuntry" className='p-1 my-3  font-mono '> Country :</label>
...
<br />
              <label htmlFor="state" className='p-1  my-3  font-mono'>State :</label>
            ...
            <div>
              ...
              <br />
              <input type="number" placeholder='OTP-verify' value={user.otp} name='otp' onChange={setdata} className='p-1  my-3  ml-19 rounded-sm border-2' />
            ...
            <div >
              ...
              <br />
              <input type="password" placeholder='Confirm Password' value={user.confirmPassword} name='confirmPassword' onChange={setdata} className='border-2 rounded-sm  my-3  ml-27' />
