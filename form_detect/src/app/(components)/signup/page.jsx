  ...
  return (
    <div>
      <div className='flex justify-center items-center h-screen bg-blue-400'>
        ...
        <div className='border-0 rounded-lg h-180  w-200 flex felx-col justify-center gap-4 p-1 m-4 bg-white font-mono font-bold'>
          <div className='mr-2'>
          ...
          <form onSubmit={handleSubmit(submitdata)} >
            <div className=' flex justify-center items-center border-2 rounded-lg bg-blue-500 p-1  my-3  w-96 font-mono'> <div></div>PLEASE SIGN UP </div>
            <input type="text" name="text" placeholder='text' className='hidden border-2 m-2' />
            <div>

              <label htmlFor="firstname" className='p-1  my-3  font-mono '> First Name :</label>
              <input type="text" name='first_name' onChange={setdata} className='border-2 p-0.5 my-3 rounded-sm' />
<br />
              <label htmlFor="lastname" className='p-1  my-3  font-mono '>Last Name :</label>
              <input type="text" name='last_name' onChange={setdata} className='border-2 p-0.5  my-3  rounded-sm' />
...
<br />
              <label htmlFor="age" className='p-1 my-3  font-mono ' >Age :</label>
...
<br />
              <input type="number" placeholder='OTP-verify' value={user.otp} name='otp' onChange={setdata} className='p-1  my-3  ml-24 rounded-sm border-2 ' />
            </div>
            <div >
              ...
              <br />
              <input type="password" placeholder='Confirm Password' value={user.confirmPassword} name='confirmPassword' onChange={setdata} className='border-2 rounded-sm  my-3  ml-31' />
            </div>
